...
//function game () {
//    for (round; ; ++round) {
//        if (playerScore == 5 || compScore == 5){ // change both number here to change needed rounds to win
//            break
//        }
...
//        }
//        else if ((((playerIndex - compIndex) % 3 + 3 ) % 3) == 1 ){ // Starts by extracting the length then goes through modulo twice to remove negative length remainder
//            ++playerScore;
